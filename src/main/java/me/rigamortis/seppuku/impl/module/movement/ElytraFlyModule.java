...
public final class ElytraFlyModule extends Module {
    ...
    public final Value<Float> stayAirborneDelay = new Value<Float>("StayAirborneDelay", new String[]{"StayAirborneWait", "sadelay"}, "Automatically disables StayAirborne when touching the ground.", 10.0f, 0.0f, 400.0f, 5.0f);
