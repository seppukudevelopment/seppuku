...
public final class NametagsModule extends Module {
    ...
    public final BooleanValue health = new BooleanValue("Health", new String[]{"Hrts"}, true);
    ...
    public NametagsModule() {
        super("Nametags", new String[]{"Tags", "Name"}, "Nametags", "NONE", -1, ModuleType.RENDER);
    }
                    ...
                    if (bounds != null) {
                        ...
                        if (e instanceof EntityPlayer) {
                            ...
                            if (this.ping.getBoolean()) {
                                ...
                                else if (this.health.getBoolean())
                        ...
                        if (e instanceof EntityLivingBase) {
                            ...
                            if (this.health.getBoolean()) {
                                final float hearts = (entityLiving.getHealth() + entityLiving.getAbsorptionAmount());
                                ...
                                if (hearts >= 20)
                                    heartsRounded = Math.round(255.0f - (20 * 255.0f / entityLiving.getMaxHealth()));
                                else
                                    heartsRounded = Math.round(255.0f - (hearts * 255.0f / entityLiving.getMaxHealth()));
